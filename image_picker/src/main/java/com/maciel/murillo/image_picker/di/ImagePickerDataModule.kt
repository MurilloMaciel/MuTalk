...
import com.maciel.murillo.image_picker.data.remote.ImagePickerRemoteDataSourceImpl
...
interface ImagePickerDataModule {
    ...
    @Binds
    fun bindRemoteDataSource(dataSource: ImagePickerRemoteDataSourceImpl): ImagePickerRemoteDataSource
